...
RSpec.describe Api::V1::Mobile::Enrollment::EmployeeEnrollment, dbclean: :after_each do
  ...
  context 'Enrollments' do
    ...
    it 'should return employee enrollments' do
      ...
      expect(active_health).to include(:health_link_id, :hbx_enrollment_id, :status, :employer_contribution,
                                       :employee_cost, :total_premium, :plan_name, :plan_type, :metal_level,
                                       :benefit_group_name)
      expect(renewal_health).to include(:health_link_id, :hbx_enrollment_id, :status, :employer_contribution,
                                        :employee_cost, :total_premium, :plan_name, :plan_type, :metal_level,
                                        :benefit_group_name)
    ...
    it 'should initialize enrollments' do
      ...
      expect(enrollments).to include(:health_link_id, :hbx_enrollment_id, :status, :employer_contribution, :employee_cost, :total_premium, :plan_name,
