...
set :repo_url, 'https://github.com/dchealthlink/enroll-mobile-api.git'
...
set :linked_files, (fetch(:linked_files, []) | ['config/mongoid.yml', 'config/initializers/devise.rb', 'config/secrets.yml', "config/environments/production.rb", "config/symmetric-encryption.yml",'config/saml.yml', 'config/unicorn.rb', 'eyes/enroll.eye.rb', 'config/marketing.yml', 'pem/symmetric.pem'])
