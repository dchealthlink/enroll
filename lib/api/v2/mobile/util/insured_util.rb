module Api
  module V2
    module Mobile::Util
      class InsuredUtil < Api::V2::Mobile::Base

        def build_response
          begin
            insured_employee = ->() {
              @insured_employee ||= Api::V2::Mobile::Insured::InsuredEmployee.new person: @person
            }

            ins_individual = ->() {
              @insured_individual ||= Api::V2::Mobile::Insured::InsuredIndividual.new person: @person
            }
